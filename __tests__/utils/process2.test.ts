...
describe('execute', () => {
	...
	it('should skip (close event, no diff))', async() => {
		...
		stdoutCalledWith(mockStdout, [
			...
			'> Fetching...',
			'[command]git remote add origin',
			'[command]git fetch --no-tags origin \'refs/heads/test/test-1:refs/remotes/origin/test/test-1\' \'refs/heads/master:refs/remotes/origin/master\' \'refs/heads/hello-world/new-topic1:refs/remotes/origin/hello-world/new-topic1\'',
	...
	it('should do schedule', async() => {
		...
		stdoutCalledWith(mockStdout, [
			...
			'> Fetching...',
			'[command]git remote add origin',
			'[command]git fetch --no-tags origin \'refs/heads/hello-world/test-1:refs/remotes/origin/hello-world/test-1\' \'refs/heads/master:refs/remotes/origin/master\' \'refs/heads/feature/new-topic1:refs/remotes/origin/feature/new-topic1\'',
	...
	it('should process default branch', async() => {
		...
		stdoutCalledWith(mockStdout, [
			...
			'> Fetching...',
			'[command]git remote add origin',
			'[command]git fetch --no-tags origin \'refs/heads/hello-world/test-0:refs/remotes/origin/hello-world/test-0\' \'refs/heads/master:refs/remotes/origin/master\'',
